...
public static class StoryCopy
{
    ...
    public static string ConnectorPhrase(ChainLink link) => link.Kind switch
    {
        ...
        _ => link.RuleId switch
        {
            ...
            "smitten" => "the hand struck them down — therefore,",
            "stroke-of-ill-fortune" => "the curse bit at once — therefore,",
            "stroke-of-good-fortune" => "the blessing took at once — therefore,",
